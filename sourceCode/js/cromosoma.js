...
function comprobarPuzzle(){
	if((document.getElementById('subi1')&&(document.getElementById('subi2')&&(document.getElementById('subi3').parentNode.id=='uno'))) |
       ...
       (document.getElementById('acro1')&&(document.getElementById('acro2')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro1')&&(document.getElementById('acro2')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro1')&&(document.getElementById('acro3')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro1')&&(document.getElementById('acro4')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro1')&&(document.getElementById('acro4')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro1')&&(document.getElementById('acro3')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro3')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro3')&&(document.getElementById('acro1').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro1')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro1')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro4')&&(document.getElementById('acro1').parentNode.id=='tres'))) |
       (document.getElementById('acro2')&&(document.getElementById('acro4')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro2')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro4')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro4')&&(document.getElementById('acro1').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro2')&&(document.getElementById('acro1').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro1')&&(document.getElementById('acro4').parentNode.id=='tres'))) |
       (document.getElementById('acro3')&&(document.getElementById('acro1')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro1')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro1')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro2')&&(document.getElementById('acro3').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro2')&&(document.getElementById('acro1').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro3')&&(document.getElementById('acro2').parentNode.id=='tres'))) |
       (document.getElementById('acro4')&&(document.getElementById('acro3')&&(document.getElementById('acro1').parentNode.id=='tres'))) &&
