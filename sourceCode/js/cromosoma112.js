...
**/
function over(e) {
	if ((e.target.className == "crom_f1 nums") || (e.target.id == "cont_cromo"))
		return false;
	else
	return true;
}
...
function comprobarPuzzle(){
	if((document.getElementById('subi1'),(document.getElementById('subi2'),(document.getElementById('subi3').parentNode.id=='uno'))) |
       (document.getElementById('subi1'),(document.getElementById('subi2'),(document.getElementById('subi4').parentNode.id=='uno'))) |       (document.getElementById('subi1'),(document.getElementById('subi3'),(document.getElementById('subi4').parentNode.id=='uno'))) |
       ...
       (document.getElementById('subi1'),(document.getElementById('subi2'),(document.getElementById('subi4').parentNode.id=='dos'))) |       (document.getElementById('subi1'),(document.getElementById('subi3'),(document.getElementById('subi4').parentNode.id=='dos'))) |
...
(document.getElementById('meta4'),(document.getElementById('meta2'),(document.getElementById('meta1').parentNode.id=='tres'))) |
       ...
       (document.getElementById('meta1'),(document.getElementById('meta2'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta1'),(document.getElementById('meta2'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta1'),(document.getElementById('meta3'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta1'),(document.getElementById('meta4'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta1'),(document.getElementById('meta4'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta1'),(document.getElementById('meta3'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta3'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta3'),(document.getElementById('meta1').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta1'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta1'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta4'),(document.getElementById('meta1').parentNode.id=='cuatro'))) |
       (document.getElementById('meta2'),(document.getElementById('meta4'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta2'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta4'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta4'),(document.getElementById('meta1').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta2'),(document.getElementById('meta1').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta1'),(document.getElementById('meta4').parentNode.id=='cuatro'))) |
       (document.getElementById('meta3'),(document.getElementById('meta1'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta1'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta1'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta2'),(document.getElementById('meta3').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta2'),(document.getElementById('meta1').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta3'),(document.getElementById('meta2').parentNode.id=='cuatro'))) |
       (document.getElementById('meta4'),(document.getElementById('meta3'),(document.getElementById('meta1').parentNode.id=='cuatro'))) &&
